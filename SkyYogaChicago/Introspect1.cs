...
namespace SkyYogaChicago
{
    ...
    public class Introspect : AppCompatActivity  , View.IOnClickListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            var toolbar = FindViewById<Toolbar>(SkyYogaChicago.Resource.Id.toolbar);
            ...
            if (!string.IsNullOrEmpty(videoTitle))
            {
                ...
                var backButton = FindViewById<Android.Widget.Button>(Resource.Id.back);
        ...
        {
            Intent intent = new Intent(this, typeof(SkyYogaChicago.MainActivity));
            StartActivity(intent);
        }
